    ...
    function inputText() {
    	...
    	//si ya se ha creado el boton no meter nada mas
        ...
        // si quiere el campo obligatorio
        var requiredText = "";
        while(requiredText==""){
        ...
        //comprobar que no se deje vacio antes de añadir
    ...
    function createButtonSend (){
    	...
    	//verificar si existe, no duplicar
    	if (!document.querySelector(".send")) {
